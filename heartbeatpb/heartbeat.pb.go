...
const (
	BlockStage_WAITING BlockStage = 0
	BlockStage_WRITING BlockStage = 1
	BlockStage_DONE    BlockStage = 2
)
...
func (m *CheckpointTsMessage) GetChangefeedID() string {
	if m != nil {
		return m.ChangefeedID
	}
	return ""
...
type BootstrapTableSpan struct {
	...
	BlockStage      BlockStage     `protobuf:"varint,7,opt,name=block_stage,json=blockStage,proto3,enum=heartbeatpb.BlockStage" json:"block_stage,omitempty"`
}
...
func (m *BootstrapTableSpan) GetBlockStage() BlockStage {
	if m != nil {
		return m.BlockStage
	}
	return BlockStage_WAITING
}
...
type State struct {
	...
	EventDone         bool              `protobuf:"varint,8,opt,name=eventDone,proto3" json:"eventDone,omitempty"`
}
...
func (m *State) GetEventDone() bool {
	if m != nil {
		return m.EventDone
	}
	return false
...
func (m *BlockStatusRequest) GetChangefeedID() string {
	if m != nil {
		return m.ChangefeedID
	}
	return ""
...
var fileDescriptor_6d584080fdadb670 = []byte{
	...
	,
}
...
func (m *BootstrapTableSpan) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	if m.BlockStage != 0 {
		i = encodeVarintHeartbeat(dAtA, i, uint64(m.BlockStage))
		i--
		dAtA[i] = 0x38
	}
	if m.BlockState != nil {
...
func (m *InfluencedTables) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.TableIDs) > 0 {
		dAtA17 := make([]byte, len(m.TableIDs)*10)
		var j16 int
		...
		i = encodeVarintHeartbeat(dAtA, i, uint64(j16))
		i--
		dAtA[i] = 0x12
	}
	if m.InfluenceType != 0 {
...
func (m *BootstrapTableSpan) Size() (n int) {
	...
	if m.BlockStage != 0 {
		n += 1 + sovHeartbeat(uint64(m.BlockStage))
	}
	return n
}
...
func (m *BootstrapTableSpan) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 7:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field BlockStage", wireType)
			}
			m.BlockStage = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.BlockStage |= BlockStage(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
