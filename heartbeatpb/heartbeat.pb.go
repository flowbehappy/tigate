...
type InfluencedTables struct {
	...
	TableNames []string `protobuf:"bytes,3,rep,name=TableNames,proto3" json:"TableNames,omitempty"`
	// only exist when type is DB.
	SchemaID   int64  `protobuf:"varint,4,opt,name=SchemaID,proto3" json:"SchemaID,omitempty"`
...
func (m *InfluencedTables) GetTableNames() []string {
	if m != nil {
		return m.TableNames
	}
	return nil
...
func (m *InfluencedTables) GetSchemaName() string {
	if m != nil {
		return m.SchemaName
	}
	return ""
...
var fileDescriptor_6d584080fdadb670 = []byte{
	...
	,
}
...
func (m *InfluencedTables) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.TableNames) > 0 {
		for iNdEx := len(m.TableNames) - 1; iNdEx >= 0; iNdEx-- {
			...
			i = encodeVarintHeartbeat(dAtA, i, uint64(len(m.TableNames[iNdEx])))
			i--
			dAtA[i] = 0x1a
		}
	}
