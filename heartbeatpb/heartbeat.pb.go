...
type TableSpanStatus struct {
	Span            *TableSpan `protobuf:"bytes,1,opt,name=span,proto3" json:"span,omitempty"`
	ComponentStatus int32      `protobuf:"varint,2,opt,name=component_status,json=componentStatus,proto3" json:"component_status,omitempty"`
	CheckpointTs    uint64     `protobuf:"varint,4,opt,name=checkpoint_ts,json=checkpointTs,proto3" json:"checkpoint_ts,omitempty"`
}
...
func (m *TableSpanStatus) GetComponentStatus() int32 {
	if m != nil {
...
var fileDescriptor_6d584080fdadb670 = []byte{
	...
	,
}
	...
	for iNdEx < l {
		...
		case 2:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.ComponentStatus |= int32(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
