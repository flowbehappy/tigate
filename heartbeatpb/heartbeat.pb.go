...
type ScheduleDispatcherRequest struct {
	ChangefeedID   string            `protobuf:"bytes,1,opt,name=changefeedID,proto3" json:"changefeedID,omitempty"`
	ID             *DispatcherID     `protobuf:"bytes,2,opt,name=ID,proto3" json:"ID,omitempty"`
	Config         *DispatcherConfig `protobuf:"bytes,3,opt,name=config,proto3" json:"config,omitempty"`
	ScheduleAction ScheduleAction    `protobuf:"varint,4,opt,name=scheduleAction,proto3,enum=heartbeatpb.ScheduleAction" json:"scheduleAction,omitempty"`
}
...
func (m *ScheduleDispatcherRequest) GetID() *DispatcherID {
	if m != nil {
		return m.ID
	}
	return nil
...
var fileDescriptor_6d584080fdadb670 = []byte{
	...
	,
}
