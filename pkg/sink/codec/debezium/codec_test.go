...
func TestEncodeInsert(t *testing.T) {
	codec := &dbzCodec{
		config:    ticommon.NewConfig(config.ProtocolDebezium),
	...
	tableInfo := common.BuildTableInfo("test", "table1", []*common.Column{{
		Name: "tiny",
		Type: mysql.TypeTiny,
		Flag: common.NullableFlag,
	}}, nil)
